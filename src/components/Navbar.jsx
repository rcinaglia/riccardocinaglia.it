...
function Navbar() {
    ...
    return (
        <>
            <header className="relative z-50 mx-auto w-[80%] font-mono align-middle">
            ...
            <div
                className={`font-mono fixed inset-0 bg-black bg-opacity-90 text-white flex flex-col justify-center items-center space-y-6 text-2xl transition-all duration-300 z-40 ${
